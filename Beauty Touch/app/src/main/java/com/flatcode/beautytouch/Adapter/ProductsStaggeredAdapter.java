...
public class ProductsStaggeredAdapter extends RecyclerView.Adapter<ProductsStaggeredAdapter.ViewHolder> {

    private final Context mContext;
    private final List<Post> mPost;

    private static ItemProductGridBinding binding;

    public ProductsStaggeredAdapter(Context context, List<Post> posts) {
    ...
    @NonNull
    @Override
    public ProductsStaggeredAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        binding = ItemProductGridBinding.inflate(LayoutInflater.from(mContext), parent, false);
        return new ViewHolder(binding.getRoot());
    }

    @Override
    public void onBindViewHolder(@NonNull final ProductsStaggeredAdapter.ViewHolder holder, final int position) {
