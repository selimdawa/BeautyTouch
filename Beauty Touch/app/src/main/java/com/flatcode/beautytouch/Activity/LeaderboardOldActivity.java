...
public class LeaderboardOldActivity extends AppCompatActivity {

    private ActivityLeaderboardBinding binding;
    Context context = LeaderboardOldActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new LeaderboardOldAdapter(context, list);
    ...
    private void SessionInfo() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                VOID.Glide(false, context, tools.getOldImageSession(), binding.imageSession);
                VOID.Glide(false, context, tools.getOldImageLogo(), binding.imageLogo);
                binding.sessionNumber.setText(tools.getOldSessionNumber());
