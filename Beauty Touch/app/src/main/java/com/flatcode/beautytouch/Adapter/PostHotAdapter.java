...
public class PostHotAdapter extends RecyclerView.Adapter<PostHotAdapter.ViewHolder> {
    ...
    public PostHotAdapter(Context context, List<Post> posts) {
    ...
    @NonNull
    @Override
    public PostHotAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        binding = ItemProductLinearBinding.inflate(LayoutInflater.from(mContext), parent, false);
        return new ViewHolder(binding.getRoot());
    }

    @Override
    public void onBindViewHolder(@NonNull final PostHotAdapter.ViewHolder holder, final int position) {
