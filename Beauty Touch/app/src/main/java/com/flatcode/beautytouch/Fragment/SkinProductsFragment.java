...
public class SkinProductsFragment extends Fragment {

    private FragmentSkinProductsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSkinProductsBinding.inflate(LayoutInflater.from(getContext()), container, false);

        VOID.BannerAd(getContext(), binding.adView, DATA.BANNER_SKIN);
